...
#figure(
  image("images/execution_evidence.png", width: 95%),
  caption: [Setup and execution evidence: terminal window demonstrating application launch via `make run`, shaded JAR execution via `java -jar`, and database reset via `make reset`.],
) <fig-execution-setup>
